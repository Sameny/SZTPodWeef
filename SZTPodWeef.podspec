...
Pod::Spec.new do |s|
  s.name             = 'SZTPodWeef'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SZTPodWeef.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/shzuetai/SZTPodWeef'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shzuetai' => 'shuzetai@dakale.net' }
  s.source           = { :git => 'https://github.com/shzuetai/SZTPodWeef.git', :tag => s.version.to_s }
